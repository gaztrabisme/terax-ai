...
pub fn run() {
    ...
    tauri::Builder::default()
        ...
        .invoke_handler(tauri::generate_handler![
            ...
            pty::pty_terminal_history,
            pty::pty_terminal_output,
            pty::pty_terminal_export,
            pty::pty_terminal_retry,
            pty::pty_write,
            pty::pty_resize,
            pty::pty_close,
            pty::pty_close_all,
            ...
            pi::attachments::pi_save_draft_attachment,
            pi::attachments::pi_stage_submission,
            pi::attachments::pi_record_attachment_binding,
            pi::artifacts::pi_write_artifact,
            pi::artifacts::pi_read_artifact,
            pi::artifacts::pi_write_answer,
            pi::auth::pi_auth_status,
            pi::auth::pi_auth_set,
            pi::auth::pi_auth_clear,
            pi::pi_list_models,
            pi::pi_list_providers,
            pi::health::pi_health,
            pi::pi_prepare,
            pi::pi_send,
            pi::pi_kill,
            ...
            pi::secrets::pi_secret_clear,
            pi::secrets::pi_secret_status,
            pi::secrets::pi_secret_env_status,
